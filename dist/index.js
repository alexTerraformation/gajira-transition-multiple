...
const { countReset } = __nccwpck_require__(206)
const _ = __nccwpck_require__(752)
const Jira = __nccwpck_require__(493)
...
const { get } = __nccwpck_require__(752)

const serviceName = 'jira'
const { format } = __nccwpck_require__(310)
const client = __nccwpck_require__(598)(serviceName)
...
const fetch = __nccwpck_require__(98)
...
(() => {
const fs = __nccwpck_require__(147)
const YAML = __nccwpck_require__(298)
const core = __nccwpck_require__(938)

const configPath = `${process.env.HOME}/jira/config.yml`
const Action = __nccwpck_require__(918)
...
function parseArgs () {
  ...
  return {
    issueList: core.getInput('issueList'),
    transition,
    transitionId,
  }
}
